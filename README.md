<h1 align="center">👋 Hello Friend, I'm Jon! 🌠</h1>

<section align="center">
  <p>
    A third-year <i>Computer Science</i> student at the <i>University of British Columbia</i> in Vancouver, BC. 🍁 <br />
    🖥️ My main interest lies in <code>full-stack web development</code>, with a front-end focus of using <code>React.js</code> frameworks. <br />
    Other interests include <code>game development</code> in <code>Unity</code>, <code>data science</code>, and <code>machine learning</code>. 📊
  </p>

  <p>
    🤖 As for hobbies, I make graphic designs, and create 3D models in Blender. <br />
    I also enjoy songwriting, as well as making beats and producing music in FL Studio. 🎹
  </p>
</section>
...
<!--     <img src="" /> -->
  ...
  <h2 align="center">Testing & Debugging</h2>
  <section align="center">
...
<!--
**jon-chow/jon-chow** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
